...
class TrainerNet(object):
    ...
    def run_training(self):
        ...
        while epoch < config.num_epochs:
            ...
            log_stats_sac(self.buff, q_target, q_local_1, q_local_2, pg_loss, v_loss_1, v_loss_2, self.entropy_factor,
                          norm_entropy, train_wheels_engaged_sum/train_wheels_engaged_len, elapsed, start_wall_time,
                          self.monitor, proj_eta, epoch, curr_wall_time, self.env.timeline_len())
